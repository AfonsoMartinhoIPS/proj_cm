...
/// Themed primary button. `darkTheme` flips to outlined-secondary style.
/// `secondaryText` appends a bolder span next to the main label.
          ...
          child: Row(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  color: darkTheme ? AppColors.secondary : AppColors.onBackground,
                  fontSize: 15,
                  fontFamily: 'DM Sans',
